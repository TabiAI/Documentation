...
```bash
curl https://api.travelbase.ai/v1/tenant \
...
To interact with the Travelbase API, you must authenticate your requests using an API key. This key identifies your application and ensures your data remains secure.
