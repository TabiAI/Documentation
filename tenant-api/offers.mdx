...
| Parameter | Description |
| :--- | :--- |
| `include_additional_baggage` | Set to `true` to include normalized additional baggage options. |
...
```bash
curl "https://sandbox.travelbase.ai/v1/air/offers/off_123?include_additional_baggage=true" \
  -H "x-api-key: tb_test_xxxxxxxxx"
```
